public class SearchInRotSortedArrayOne {
    // O(n, 1)
    ...
    public static void main(String[] args) {
        System.out.println(v1(new int[]{4,5,6,7,0,1,2}, 0));
        System.out.println(v1(new int[]{4,5,6,7,0,1,2}, 3));
        System.out.println(v2(new int[]{4,5,6,7,0,1,2}, 0));
        System.out.println(v2(new int[]{4,5,6,7,0,1,2}, 3));
    }
}
